...
if df is not None:
    ...
    # --- TABET E DHENAVE (Me width='stretch') ---
    ...
    def generate_html_report(dataframe):
        ...
        html += f"<h1>Raporti i Planit të Shitjeve - {report_dt}</h1>"
    ...
    if st.sidebar.button("Gjenero Raportin HTML"):
        ...
        href = f'<a href="data:text/html;base64,{b64}" download="Plani_Agjentet.html" style="padding:10px; background-color:#2e75b6; color:white; text-decoration:none; border-radius:5px;">Shkarko Raportin</a>'
