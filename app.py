...
def load_data():
    ...
    try:
        ...
        # Pastrimi i kolonave (Fix për Bekimin dhe të tjerët)
...
if df is not None:
    ...
    # --- RREGULLIMI I FORMATIMIT (Fix për screenshot-in tend) ---
    config_kolonave = {
    ...
    if klientet_selected:
        ...
        with t1:
            ...
            df_k['Cmimi_Mes'] = df_k['Vlera_Planifikuar'] / df_k['Plani_KG'].replace(0, 1)
        ...
        with t2:
            ...
            df_a['Cmimi_Mes'] = df_a['Vlera_Planifikuar'] / df_a['Plani_KG'].replace(0, 1)
        ...
        with t3:
            ...
            df_kl['Cmimi_Mes'] = df_kl['Vlera_Planifikuar'] / df_kl['Plani_KG'].replace(0, 1)
